...
//		service.addProduct(new Product("BlackBeast", "Computer", "White Table", 2020));
		...
		System.out.println("==============================================");
		System.out.println("Get Products by a particular place");
		List<Product> prodsByPlace = service.getProductByPlace("White table");
		for(Product product : prodsByPlace){
			System.out.println(product);
		}

		System.out.println("==============================================");
		System.out.println("Get Products that are out of warranty");
		List<Product> outOfWarrantyProducts = service.getOutOfWarrantyProducts();
		outOfWarrantyProducts.forEach(product -> System.out.println(product));
